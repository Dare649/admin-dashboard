                  ...
                  <tbody>
                    {
                      delivery.map((delivery, index) =>(
                        <tr key={index} className='py-6 divide-y font-medium divide-slate-200  hover:bg-slate-200'>
                          ...
                          <td className='py-2 px-5 text-delivery'>{delivery.name}</td>
                          <td className='py-2 px-5 text-delivery'>{delivery.dispatcher}</td>
                  ...
                  <tbody>
                    {
                      transaction.map((transaction, i) =>(
                        <tr key={i} className='py-6 divide-y  font-medium divide-slate-200 hover:bg-slate-200'>
                          {/* <td className='py-2 px-5'>{delivery.id}</td> */}
                          <td className='py-2 px-5'>{transaction.date}</td>
                          <td className='py-2 px-5 text-delivery'>{transaction.customer}</td>
                          <td className='py-2 px-5 text-delivery'>{transaction.amount}</td>
                          <td className='py-2 px-5 capitalize'>{transaction.status}</td>
                        </tr>
                      ))
                    }
                  </tbody>
